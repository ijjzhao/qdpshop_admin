          ...
          <el-form-item label="卡券颜色" v-if="isWxcard">
            <el-dropdown @command="handleColorClick" trigger="click">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="Color010" class="Color010">Color010</el-dropdown-item>
                <el-dropdown-item command="Color020" class="Color020">Color020</el-dropdown-item>
                <el-dropdown-item command="Color030" class="Color030">Color030</el-dropdown-item>
                <el-dropdown-item command="Color040" class="Color040">Color040</el-dropdown-item>
                <el-dropdown-item command="Color050" class="Color050">Color050</el-dropdown-item>
                <el-dropdown-item command="Color060" class="Color060">Color060</el-dropdown-item>
                <el-dropdown-item command="Color070" class="Color070">Color070</el-dropdown-item>
                <el-dropdown-item command="Color080" class="Color080">Color080</el-dropdown-item>
                <el-dropdown-item command="Color081" class="Color081">Color081</el-dropdown-item>
                <el-dropdown-item command="Color082" class="Color082">Color082</el-dropdown-item>
                <el-dropdown-item command="Color090" class="Color090">Color090</el-dropdown-item>
                <el-dropdown-item command="Color100" class="Color100">Color100</el-dropdown-item>
                <el-dropdown-item command="Color101" class="Color101">Color101</el-dropdown-item>
                <el-dropdown-item command="Color102" class="Color102">Color102</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    logoUploadSuccess(file,filelist) {
      let obj = {}
      obj.url = api.UploadAddress + filelist.response.key
      this.logoImg = [obj]
      this.ruleForm.logo_url = obj.url;
      console.log(obj.url);
    },
    logoRemove() {
      this.logoImg = []
    ...
    getInfo() {
      this.axios
        .post("coupon/findcouponinfoById", {
          id: this.id
        })
        .then(res => {
          console.log(res);
          this.datepickerPlaceholder =
            ...
            " 天 ";
          this.ruleForm.logo_url = res.data.data.logo_url;
          let obj = {}
          obj.url = res.data.data.logo_url
          this.logoImg = [obj]
